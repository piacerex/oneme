...
| Phase 8: commercial operations | `contract_done` | `docs/commercial-operations.md`, team, usage, billing, webhook, audit, asset review, asset validation, monitoring, incident, status page update, legal, and ops summary schemas |
